...
inline void SinglyLinkList<T>::CopyList(const SinglyLinkList<T> &other_l) {
  ...
  m_head = new Node(other_l.m_head->m_data);

  NodePointer curren_this = m_head;
  NodePointer current_other = other_l.m_head->m_next;

  while (current_other != nullptr) {
    curren_this->m_next = new Node(current_other->m_data);
